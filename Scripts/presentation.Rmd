...
This function creates a short movie with the camera panning
```{r, warning=FALSE, error=FALSE}
sfv<- raster_to_matrix(here("Data", "sanfernandovalley.tif"))
#if(interactive()) {
  #filename_movie ="sfvmovie"
sfv %>%
...
```
---
This is the video created with the render_movie
[link to video](https://drive.google.com/file/d/1ya6A9cGMa-mx3V8lWsL9GiDGFxvIpvMt/view?usp=sharing)
